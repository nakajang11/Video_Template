...
Optional source-analysis evidence may also exist:
...
- `evidence_artifacts.timeline_view`
- `evidence_artifacts.transcript_packed`

Use these only when generated by `$video-analysis-support`.
